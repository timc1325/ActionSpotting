...
if __name__ == "__main__":
    ...
    fold = 0  # or ensemble
    gpu_id = 0
    challenge = False  # or True if you're using challenge set

    prediction_dir = constants.predictions_dir / experiment / "cv" / f"fold_{fold}"
    visualization_dir = constants.visualizations_dir / experiment / "cv" / f"fold_{fold}"
    visualize_game(game, prediction_dir, visualization_dir, gpu_id, challenge)
